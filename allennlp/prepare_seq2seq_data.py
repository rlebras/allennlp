...
#        additional_data = json.load(f)
 ...
 #   all_train_subsets = create_sentence_aligned_data(data[:-100])
    write_data(data[:-500], 'sigmadolphin_train.txt', randomize=True, num_iters=3)
    write_data(data[-500:], 'sigmadolphin_dev.txt', randomize=False, num_iters=1)
    write_data(data[-500:], 'sigmadolphin_test.txt', randomize=True, num_iters=1)
